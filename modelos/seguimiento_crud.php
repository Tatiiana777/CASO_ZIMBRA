...
class Seguimiento_crud {
    ...
    public function create($seguimiento) {
        ...
        $crear = $db -> prepare('INSERT INTO seguimiento (fecha, canal, resultado, proxima_accion, notas, id_lead, id_usuario) VALUES (:fecha, :canal, :resultado, :proxima_accion, :notas, :id_lead, :id_usuario)');
        ...
        $crear->bindValue(':notas', $seguimiento->getNotas());
    ...
    public function update($seguimiento) {
        ...
        $actualizar = $db->prepare(
            'UPDATE seguimiento
            SET fecha = :fecha, canal = :canal, resultado = :resultado, proxima_accion = :proxima_accion, notas = :notas, id_lead = :id_lead, id_usuario = :id_usuario
        ...
        $actualizar->bindValue(':notas', $seguimiento->getNotas());

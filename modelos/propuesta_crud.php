...
class Propuesta_crud {
    ...
    public function create($propuesta) {
        ...
        $crear = $db -> prepare('INSERT INTO propuesta (fecha_creacion, fecha_vigencia, valor_total, estado, observaciones, id_lead, id_usuario) VALUES (:fecha_creacion, :fecha_vigencia, :valor_total, :estado, :observaciones, :id_lead, :id_usuario)');
        $crear->bindValue(':fecha_creacion', $propuesta->getFechaCreacion());
        ...
        $crear->bindValue(':observaciones', $propuesta->getObservaciones());
    ...
    public function update($propuesta) {
        ...
        $actualizar = $db->prepare(
            'UPDATE propuesta
            SET fecha_creacion = :fecha_creacion, fecha_vigencia = :fecha_vigencia, valor_total = :valor_total, estado = :estado, observaciones = :observaciones, id_lead = :id_lead, id_usuario = :id_usuario
            WHERE id_propuesta = :id_propuesta'
        );

        $actualizar->bindValue(':id_propuesta', $propuesta->getIdPropuesta());
        $actualizar->bindValue(':fecha_creacion', $propuesta->getFechaCreacion());
        ...
        $actualizar->bindValue(':observaciones', $propuesta->getObservaciones());
